...
import { 
  X, Terminal as TerminalIcon, Maximize2, Minimize2, 
...
// Types for xterm - these are imported dynamically
...
const Terminal = forwardRef<{
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const webLinksAddon = new WebLinksAddon((event: unknown, uri: string) => {
