...
impl MCPAgent {
    ...
    async fn plan_actions(&self, command: &str, context: &AgentContext) -> Result<ExecutionPlan> {
    ...
    fn build_planning_prompt(&self, command: &str, context: &AgentContext) -> Result<String> {
    ...
    fn validate_action(&self, action: &AgentAction, context: &AgentContext) -> Result<()> {
    ...
    async fn execute_single_action(&self, action: &AgentAction) -> Result<()> {
    ...
    pub async fn approve(&self, approval_id: &str, context: &AgentContext) -> Result<AgentResult> {
    ...
    pub fn reject(&self, approval_id: &str) -> Result<()> {
